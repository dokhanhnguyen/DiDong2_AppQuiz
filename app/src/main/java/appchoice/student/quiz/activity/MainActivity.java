...
import appchoice.student.quiz.dialog.SubjectDialog;
import appchoice.student.quiz.dialog.ToggleDialog;
import appchoice.student.quiz.fragment.HistoryFragment;
import appchoice.student.quiz.fragment.HomeFragment;
import appchoice.student.quiz.fragment.ImportedFragment;
import appchoice.student.quiz.fragment.ImportedgvFregment;
import appchoice.student.quiz.fragment.ScoreboardFragment;
import appchoice.student.quiz.model.Subject;
import appchoice.student.quiz.utils.InputHelper;
import appchoice.student.quiz.utils.Pref;
import appchoice.student.quiz.utils.Units;
import appchoice.student.quiz.utils.UniversalImageLoader;
...
public class MainActivity extends AppCompatActivity implements OnSubjectListener,
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            ...
            case R.id.item_exam:
                showActivity(ExamActivity.class); break;
            case R.id.item_filter: showToggleDialog(); break;
        }
        return true;
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_home: toggleFragment(item); break;
            case R.id.nav_imported: toggleFragment(item); break;
            case R.id.nav_exam:
                //sửa chỗ này
                try {
                    if(mAuth.getCurrentUser()!=null) {
                        ...
                        break;
                    }else{Toast.makeText(MainActivity.this,"Bạn cần phải đăng nhập!",Toast.LENGTH_SHORT).show();}
                }catch (Exception e){
                    Toast.makeText(MainActivity.this,"Bạn cần phải đăng nhập!",Toast.LENGTH_SHORT).show();
                }
                break;
            case R.id.nav_on_exam:
                ...
                break;
            case R.id.nav_history: toggleFragment(item); break;
            case R.id.nav_scoreboard: toggleFragment(item); break;
            case R.id.nav_import: showActivity(ImportActivity.class); break;
            case R.id.nav_logout:
                mAuth.signOut();
                navigationView.getMenu().findItem(R.id.nav_import_deon).setVisible(false);
                ID_GV="MEO";
                break;
            case R.id.nav_import_gv: showActivity(Timgiaovien.class);break;
            case R.id.nav_import_deon: showActivity(Importdeon.class);break;
